...
export const TopNavbar = () => {
  return (
    <div className="md:mx-6 mx-0 lg:mx-0 border-b px-6 lg:px-8 w-full py-4  flex items-center justify-between bg-primary md:rounded-xl ">
      <div className="flex items-center md:gap-9  ">
        <div className="flex items-center text-white gap-4  ">
          ...
          <h3 className="hidden md:block">6 Suggestions</h3>
        </div>

        <div>
          <h4 className="flex items-center gap-1 text-white font-normal">
            Sort by :
            <span className="flex items-center gap-2 font-medium text-white">
              Most Upvotes
              <HiOutlineChevronDown className="text-white font-bold" />
            </span>
          </h4>
        </div>
      </div>
